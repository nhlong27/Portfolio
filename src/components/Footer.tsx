...
const Footer: React.FC<FooterProps> = ({
  ...
  return (
    <footer className="w-full min-h-[18rem] bg-tertiary/30 flex flex-col justify-center items-center">
      <div className="my-auto mt-0 h-auto w-full md:w-11/12 max-w-[1920px] min-w-[300px] flex justify-center items-center flex-col gap-8 pt-16">
        ...
        <div className="flex justify-evenly flex-col md:flex-row w-3/4 md:w-3/5 min-w-[300px]">
          <MenuItem
            href="about"
