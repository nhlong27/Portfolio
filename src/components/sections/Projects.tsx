...
const Projects = () => {
  ...
  const x1 = useParallax(scrollYProgress, 50);
  const x2 = useParallax(scrollYProgress, -50);
  const x3 = useParallax(scrollYProgress, 50);
  return (
    <section
      id="projects"
      className="-mt-[10rem] md:mt-[5rem] mb-[10rem] relative grid grid-rows-3 bg-transparent p-16 gap-8 z-0"
    >
      <motion.div
        style={{ y, x: x1 }}
